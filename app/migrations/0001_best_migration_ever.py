# Generated by Django 2.1.4 on 2019-01-13 14:41
...
class Migration(migrations.Migration):
    ...
    replaces = [('app', '0001_initial'), ('app', '0002_auto_20190112_1337'), ('app', '0003_auto_20190112_1337'), ('app', '0004_auto_20190113_1440')]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='studenttestquestion',
            name='question',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='test_questions', to='app.TopicQuestion', verbose_name='Конкретный вопрос для студента'),
        ),
        migrations.AddField(
            model_name='studenttestquestion',
            name='test',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='questions', to='app.StudentTest', verbose_name='Тест'),
        ),
        migrations.AddField(
            model_name='studenttestquestion',
            name='test_question',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='student_test_questions', to='app.Question', verbose_name='Вопрос из теста преподавателя'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='question',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='answer', to='app.StudentTestQuestion', verbose_name='Вопрос'),
        ),
        migrations.AddField(
            model_name='question',
            name='test',
        ...
        migrations.AlterField(
            model_name='question',
            name='number',
            field=models.PositiveSmallIntegerField(default=1, help_text='Номер вопроса в рамках теста уникале', verbose_name='Номер вопроса в тесте'),
        ),
        migrations.AlterField(
            model_name='question',
            name='number',
            field=models.PositiveSmallIntegerField(default=1, help_text='Номер вопроса в рамках теста уникален', verbose_name='Номер вопроса в тесте'),
        ),
        migrations.AlterField(
            model_name='question',
            name='number',
            field=models.PositiveSmallIntegerField(default=1, help_text='Номер вопроса в рамках теста должен быть уникален', verbose_name='Номер вопроса в тесте'),
        ),
    ]
